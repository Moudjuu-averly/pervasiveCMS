...
class ProductForm(forms.ModelForm):
    product_tittle = forms.CharField(widget=forms.TextInput(
        attrs={
            'class': 'form-control',
            'placeholder': 'product tittle...',
            'data-validation':'required',
            'data-validation-help':'Provide a Product Need title.'
        }
    ))
    ...
    ), choices=Product.PRODUCT_CATEGORY_CHOICES
    )
    product_video = forms.FileField(widget=forms.FileInput(
        attrs={
            'class': 'form-control',
            'name': 'product_video',
            'type': 'file',
            'data-validation':'required',
            'data-validation-help':'Upload a video for this Product please.'
        }
    )
    )
